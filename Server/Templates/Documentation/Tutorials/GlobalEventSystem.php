...
<pre><code><?= Code::Class("vDesk") ?>.Events.<span class="Class">EventDispatcher</span>.<span class="Function">addEventListener</span>(<span class="Argument String">"vDesk.Archive.Element.Deleted"</span>, <span class="Argument Object">Event</span> => <span class="Class">console</span>.<span class="Function">log</span>(<span class="Argument Object">Event.data</span>)[, <span class="Argument Bool">false</span>]);</code></pre>
